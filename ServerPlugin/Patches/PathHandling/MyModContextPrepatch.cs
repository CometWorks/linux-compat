...
//
// The injected getter calls into ServerPlugin.Patches.PathHandling.
...
public static class MyModContextPrepatch
{
    ...
    private static MethodReference ImportToWindowsPath(ModuleDefinition module)
    {
        ...
        var pathHelpersType = new TypeReference(
            "ServerPlugin.Patches.PathHandling", "PathHelpers", module, linuxCompatRef, false);
        ...
        MethodReference toWindowsPath)
    {
        ...
        // Body, equivalent C#:
        //   return ServerPlugin.Patches.PathHandling.PathHelpers
